namespace MiniORM
{
        ...
        where T : class, new()
    {
        ...
        public IEnumerable<T> GetModifiedEntities(DbSet<T> dbSet)
        {
            ...
            {
                var primaryKeyValues = GetPrimaryKeyValues(primeryKeys, proxyEntity)
                    .ToArray();

                var entity = dbSet
                    .Entities
                    .Single(e => GetPrimaryKeyValues(primeryKeys, e)
        ...
        private static IEnumerable<Object> GetPrimaryKeyValues(IEnumerable<PropertyInfo> primeryKeys, T entity)
        => primeryKeys.Select(pk => pk.GetValue(entity));
